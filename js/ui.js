...
const QUOTES = [
  ...
  ["只有退潮了，才知道谁在裸泳。","沃伦 · 巴菲特"],
  ["如果你不想持有一只股票十年，就不要持有它十分钟。","沃伦 · 巴菲特"],
  ["人生只有 20 个打卡孔，每做一个重大投资决定就打掉一个——贵精不贵多。","沃伦 · 巴菲特"],
  ["滚雪球要找很湿的雪和很长的坡。","沃伦 · 巴菲特"],
  ["用合理的价格买伟大的公司，好过用便宜的价格买平庸的公司。","沃伦 · 巴菲特"],
  ["时间是好公司的朋友，是平庸公司的敌人。","沃伦 · 巴菲特"],
  ["如果我知道我会死在哪儿，我就一辈子不去那儿。","查理 · 芒格"],
  ["反过来想，总是反过来想。","查理 · 芒格"],
  ["想得到某样东西，最可靠的办法是让自己配得上它。","查理 · 芒格"],
  ["知道自己能力圈的边界，比圈大圈小重要得多。","查理 · 芒格"],
  ["市场短期是投票机，长期是称重机。","本杰明 · 格雷厄姆"],
  ["投资者最大的敌人，往往是他自己。","本杰明 · 格雷厄姆"],
  ["卖出赢家、抱住输家，就像剪掉花朵去浇灌杂草。","彼得 · 林奇"],
  ["知道自己买的是什么、为什么买——『它肯定会涨』不是理由。","彼得 · 林奇"],
  ["行情在绝望中诞生，在怀疑中成长，在乐观中成熟，在兴奋中死亡。","约翰 · 邓普顿"],
  ["投资中最危险的四个字：这次不一样。","约翰 · 邓普顿"],
  ["华尔街没有新鲜事，因为人性永远不变。","杰西 · 利弗莫尔"],
  ["让我赚到大钱的从来不是想法，而是耐心地坐着不动。","杰西 · 利弗莫尔"],
  ["做和别人一样的事，就别指望得到和别人不一样的结果。","霍华德 · 马克斯"],
  ["真正要防范的不是波动，而是不可挽回的永久损失。","霍华德 · 马克斯"],
  ["如果买入时的功课做足了，卖出的时机——几乎是永远。","菲利普 · 费雪"],
  ["善战者，先立于不败之地，而不失敌之败也。","孙子兵法"],
  ["胜兵先胜而后求战，败兵先战而后求胜。","孙子兵法"],
  ["水则资车，旱则资舟。","范蠡 · 计然之策"],
  ["贵上极则反贱，贱下极则反贵。","史记 · 货殖列传"],
  ["毋意，毋必，毋固，毋我。","论语"],
  ["凡事预则立，不预则废。","礼记"],
  ["先想清楚会怎么输，再谈能怎么赢。","风控箴言"],
  ["仓位是观点的信用，满仓是把全部信用一次押上。","仓位箴言"],
  ["止损不是认输，是买回再来一次的权利。","交易箴言"],
  ["市场每天都在发牌，你不必每把都跟。","交易箴言"],
  ["看得懂的行情才叫机会，看不懂的行情只是装饰。","交易箴言"],
  ["慢慢变富这条路不挤，因为大多数人都想抄近道。","投资箴言"],
  ["回撤 50% 要翻倍才能回本——所以风控永远排在收益前面。","复利箴言"],
  ["把睡不着的仓位减到睡得着，是最高级的风控。","仓位箴言"],
  ["别把鸡蛋放一个篮子里，但也别让篮子占满整辆车。","配置箴言"],
  ["定投的真本事不在买，而在拿得住。","基金箴言"],
  ["选择比努力重要，配置比选股重要。","配置箴言"],
  ["费率是确定的，收益是不确定的——先管住确定的。","基金箴言"],
  ["能管住手的人，才配谈眼光。","纪律箴言"],
  ["记录每一笔买入理由，是对未来自己最大的慈悲。","复盘箴言"],
  ["承认看错是进步最快的方式，市场最不缺的就是台阶。","复盘箴言"],
  ["牛市里学会的坏习惯，会在熊市里连本带利讨回去。","周期箴言"],
  ["复利需要的不是聪明，是年复一年的在场。","投资箴言"],
  ["种一棵树最好的时间是十年前，其次是现在。","谚语"],
  ["不要高估一年能做成的事，不要低估十年能做成的事。","投资箴言"],
  ["别人押注运气时，你押注纪律——运气会用完，纪律不会。","投资箴言"],
];
